            ...
            <div class="card pub_image pub_image_detail">
                ...
                <div class="card-body">
                    ...
                    <div class="likes">
                        ...
                        @if($user_like)
                        <img src="{{asset('img/red.png')}}" alt="" data-id="{{$image->id}}" class="btn-dislike">
                        @else
                        <img src="{{asset('img/gray.png')}}" alt="" data-id="{{$image->id}}" class="btn-like">
                        @endif
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Al eliminar la publicacion no se podra recuperar
                                    </div>
